...
import {
  ArrowLeft, Bell, Lock, Shield, Trash2, User,
...
import { getCurrentConsumer, isConsumerAuthenticated } from "../../../api/mock/auth";
...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    const currentUser = getCurrentConsumer();
    setUser(currentUser);
  ...
  const handleDeleteAccount = () => {
    localStorage.clear();
    localStorage.removeItem("glowup_consumer_user");
    navigate("/");
  };
