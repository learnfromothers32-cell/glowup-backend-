          ...
          <div className="grid grid-cols-2 gap-3">
            <button type="button" onClick={async () => {
              try {
                ...
                setError(err.message?.includes("sign up") ? "No account found. Please sign up first." : "Google login failed");
              }
            ...
            <button type="button" onClick={async () => {
              try {
                ...
                setError(err.message?.includes("sign up") ? "No account found. Please sign up first." : "Apple login failed");
              }
            }} className="btn-secondary py-2.5">
