    ...
    <div className="flex min-h-screen items-center justify-center bg-[#FAF8F4] dark:bg-gray-950 p-4">
      <div className="w-full max-w-md space-y-6 bg-white dark:bg-gray-900 p-8 shadow-lg rounded-xl">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-[#7A7168] dark:text-gray-400">Find your perfect stylist</p>
        </div>
        ...
        <p className="text-center text-xs text-[#7A7168] dark:text-gray-400">
          Are you a stylist?{" "}
          <Link to="/stylist/signup" className="font-medium text-[#2D2A24] dark:text-gray-200 hover:underline">
            List your services
          </Link>
        </p>
      </div>
